    ...
    return (
        ...
        <div className="row justify-content-center" style={{backgroundColor: '#13141A', height: 300}}>
          <div className="col-md-3">
            ...
            <h4 className="mt-3"><a href="/profile/teacher/:id">Profile</a></h4>
          </div>
          <div className="col-md-3">
            <div className="ellipse">
              <img src="https://drive.google.com/uc?id=16yv_Rqi4l8hiRyvZ2uUKqynBOg0ArhZ7" alt="student material" />
            </div>
              <h4 className="mt-3"><a href="/SMdashboard_T">Study Material</a></h4>
          </div>
          <div className="col-md-3">
            <div className="ellipse">
        ...
        <div className="row justify-content-center">
          <div className="col-md-3">
            <div className="ellipse">
              ...
              <h4 className=""><a href="/teacherstudentdashboard">Exams</a></h4>
          </div>
          <div className="col-md-3">
            <div className="ellipse">
          ...
          <div className="col-md-3">
            <div className="ellipse">
              ...
              <h4 className=""><a href="/leave-form">Leave Form</a></h4>
          </div>
        </div>
